...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2944.21844717459; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 3092.292438337418; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2579.72104718883; // x position of the perpendicular encoder (in tick units)
    }
